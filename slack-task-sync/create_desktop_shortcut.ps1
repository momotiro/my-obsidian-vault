...
$Shortcut.TargetPath = "C:\Users\80036\AppData\Local\Programs\Python\Python313\pythonw.exe"
...
$Shortcut.Description = "Slack Task Bot (Background)"
$Shortcut.Save()
Write-Host "Shortcut created: Desktop\Slack Task Bot.lnk"
